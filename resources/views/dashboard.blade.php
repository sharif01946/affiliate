        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $donars->count() }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
                        ...
                        <tbody>
                            @foreach ($affiliates as $item)
                                <tr>
                                    ...
                                    <td>
                                        {{ $item->commisions->sum("click") }}
                                    </td>
                                    <td>
                                        {{ $item->commisions->sum("sales") }}
                                    </td>
                                    <td>
                                        {{ $item->commisions->sum("lead") }}
                                    </td>
                                    <td>
                                        {{ $item->commisions->sum("impression") }}
                                    </td>
                                    <td>
                                        {{ $item->commisions->sum("amount") }}
                                    </td>
                                    <td>
                                        <ul class="list-inline">
                                            <li>
                                                <a href="{{ URL::to('admin/affiliate/commisions/'.$item->id) }}"><i class="fa fa-eye"></i> View</a> 
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
