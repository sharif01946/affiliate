...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/backpack/pnotify/pnotify.custom.min.css') }}">

    <!-- BackPack Base CSS -->
    <link rel="stylesheet" href="{{ asset('assets/backpack/backpack.base.css') }}">
...
<body class="hold-transition {{ config('backpack.base.skin') }} sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          @include('charity.inc.menu')
        </nav>
      </header>

      <!-- =============================================== -->

      @include('charity.inc.sidebar')
    ...
    <script>window.jQuery || document.write('<script src="{{ asset('assets/adminlte') }}/plugins/jQuery/jQuery-2.2.0.min.js"><\/script>')</script>
    <!-- Bootstrap 3.3.5 -->
