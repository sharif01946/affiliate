    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-default">
                ...
                <div class="box-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/charity/login') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="{{ url('/charity/password/reset') }}">{{ trans('backpack::base.forgot_your_password') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
