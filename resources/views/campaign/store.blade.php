            ...
            <form role="form" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="cname" placeholder="Type in your Campaign name" value="{{ $item->name }}" required>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="product_id" id="affiliate-name" class="form-control" required>
                                    @foreach ($products as $aff)
                                        <option value="{{ $aff->id }}" {{ $item->product_id == $aff->id ? "selected":"" }}>{{ $aff->name }}</option>
                                    @endforeach
                                </select>                                
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="url" id="curl" value="{{ $item->url }}" placeholder="Will be created on update" readonly="">
                    </div>
