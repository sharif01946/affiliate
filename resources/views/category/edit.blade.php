...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <form action="{{ url('admin/category/'.$categorys->id) }}" role="form" method="post">
                 {{ csrf_field() }}
                 {{ method_field('patch') }}                
                <div class="box-body"> 
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="cname" placeholder="Type in your Category name" value="{{ $categorys->name }}" required>
                            </div>
                        </div>
