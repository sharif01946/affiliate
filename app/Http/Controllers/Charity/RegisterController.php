...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected $redirectPath = '/charity/login';
    ...
    public function showRegistrationForm()
    {
        ...
        $this->data['groups'] = \App\CharityGroup::all(); // set the page title
        return view('charity.auth.register', $this->data);
    }
